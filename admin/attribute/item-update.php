...
##*** proceess
	...
	if ($act == "1"){
		...
		$vie_size[vie_w]=300;
		$vie_size[vie_h]=300;
		table_upload_image("tbl_attribute", $id, "tmp_photo_$photo_index", $photo_index, $icon_size, $thu_size, $vie_size);
		...
		$vie_size[vie_w]=300;
		$vie_size[vie_h]=300;
		//table_upload_image("", $id, "tmp_photo_$photo_index", $photo_index, $icon_size, $thu_size, $vie_size);		
		
		
		## upload attachment
		//table_upload_file("", $id, "tmp_file_1", 1);
