		...
		<table>
			...
			<tbody>
            	<tr style="background-color:#eee;">
                	<td colspan="6" align="right">Bulk Edit</td>
						...
						if ($row = mysql_fetch_array($result)){
							...
							<tr>
								<td align="left">
                                    ...
                                    <div style=" font-size: 9px; color:#aaa; ">
                                    <a href="../product-price/price-history.php?id=<?=$row[id]; ?>" target="_blank">view history</a>                                    </div>                                </td>
								<td align="left"><!--<input type="text" id="note_text_<?=$row[id];?>" name="note_text_<?=$row[id]; ?>" value="<?=$row[note_text]; ?>" style="width:60px" />-->
									<textarea id="note_text_<?=$row[id];?>" name="note_text_<?=$row[id]; ?>" ><?=$row[note_text]; ?></textarea>
								</td>
								<td align="left"> 
								...
								<td align="left">
                                    ...
                                    <option value="<?=5;?>" <? if($row[stock_status]==5){ echo "selected"; } ?>><?=get_stock_status(5); ?></option>                                   
                                    </select>                                </td>                                                                
