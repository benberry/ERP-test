...
$func_name = "Supllier";
$tbl = "tbl_supplier";
$prev_page = "wms.supplier.list";
$curr_page = "wms.supplier.edit";
$action_page = "wms.supplier.update";
...
<div id="edit">
		...
		<div id="tabs">
			<ul>
				...
				<!--
				<?// if (!empty($id)) { ?>
					<li><a href="#tabs-2" onclick="$('#tab_curr').val(1)">Other</a></li>					
				<?// } ?>
				-->
			</ul>
			
			<div id="tabs-1"><? include("wms.supplier.tab-main.php") ?></div>
			<!--
			<? //if (!empty($id)) { ?>
