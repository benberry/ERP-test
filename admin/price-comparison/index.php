...
$chkDrop_shopbot = "A";
$chkDrop_shopping = "A";
$chkDrop_myshopping = "A";
$chkDrop_pricerunner = "A";
$chkDrop_priceme = "A";
$chkDrop_google = "A";
$chkDrop_google_uk = "A";
...
if(isset($_REQUEST["srccond"]))
{
  $strExp = explode("_",$_REQUEST["srccond"]);
	...
	if($strExp[0]=='getprice')
		$chkDrop_getprice = $strExp[1];
	if($strExp[0]=='shopbot')
		$chkDrop_shopbot = $strExp[1];	 
	if($strExp[0]=='shopping')
		$chkDrop_shopping = $strExp[1];
	if($strExp[0]=='myshopping')
		$chkDrop_myshopping = $strExp[1];
	if($strExp[0]=='pricerunner')
		$chkDrop_pricerunner = $strExp[1];
	if($strExp[0]=='priceme')
		$chkDrop_priceme = $strExp[1];
	if($strExp[0]=='google')
		$chkDrop_google = $strExp[1];	
	if($strExp[0]=='google-uk')
		$chkDrop_google_uk = $strExp[1];
  ...
  if($strExp[1] != 'A')
  {
    if($strExp[1]=='S') 
	  ...
	  $disCon = 0;
    $sql .= " and display_to_".str_replace("-","_",$strExp[0]). " = $disCon ";	
  } 	
}
	...
	<div id="list">
		...
		<table>
			...
			<tbody>
				...
				<tr>
                    <td colspan="7" align="right"></td>
                    <td align="right"><select name="drpgetprice" onchange="filterRec(this.value,'<?php echo $_SERVER['PHP_SELF'];?>','getprice')" ><option  value="A" <?php if($chkDrop_getprice=='A') echo "selected";?> >All</option><option value="S" <?php if($chkDrop_getprice=='S') echo "selected";?>>Selected</option><option value="D" <?php if($chkDrop_getprice=='D') echo "selected";?>>Deselected</option></select></td>
                    <td align="right"><select name="drpshopbot" onchange="filterRec(this.value,'<?php echo $_SERVER['PHP_SELF'];?>','shopbot')" ><option  value="A" <?php if($chkDrop_shopbot=='A') echo "selected";?> >All</option><option value="S" <?php if($chkDrop_shopbot=='S') echo "selected";?>>Selected</option><option value="D" <?php if($chkDrop_shopbot=='D') echo "selected";?>>Deselected</option></select></td>
                    <td align="right"><select name="drpshopping" onchange="filterRec(this.value,'<?php echo $_SERVER['PHP_SELF'];?>','shopping')" ><option  value="A" <?php if($chkDrop_shopping=='A') echo "selected";?> >All</option><option value="S" <?php if($chkDrop_shopping=='S') echo "selected";?>>Selected</option><option value="D" <?php if($chkDrop_shopping=='D') echo "selected";?>>Deselected</option></select></td>
                    <td align="right"><select name="drpmyshopping" onchange="filterRec(this.value,'<?php echo $_SERVER['PHP_SELF'];?>','myshopping')" ><option  value="A" <?php if($chkDrop_myshopping=='A') echo "selected";?> >All</option><option value="S" <?php if($chkDrop_myshopping=='S') echo "selected";?>>Selected</option><option value="D" <?php if($chkDrop_myshopping=='D') echo "selected";?>>Deselected</option></select></td>
                    <td align="right"><select name="drppricerunner" onchange="filterRec(this.value,'<?php echo $_SERVER['PHP_SELF'];?>','pricerunner')" ><option  value="A" <?php if($chkDrop_pricerunner=='A') echo "selected";?> >All</option><option value="S" <?php if($chkDrop_pricerunner=='S') echo "selected";?>>Selected</option><option value="D" <?php if($chkDrop_pricerunner=='D') echo "selected";?>>Deselected</option></select></td>
                    <td align="right"><select name="drppriceme" onchange="filterRec(this.value,'<?php echo $_SERVER['PHP_SELF'];?>','priceme')" ><option  value="A" <?php if($chkDrop_priceme=='A') echo "selected";?> >All</option><option value="S" <?php if($chkDrop_priceme=='S') echo "selected";?>>Selected</option><option value="D" <?php if($chkDrop_priceme=='D') echo "selected";?>>Deselected</option></select></td>
					<td align="right"><select name="drpgoogle" onchange="filterRec(this.value,'<?php echo $_SERVER['PHP_SELF'];?>','google')" ><option  value="A" <?php if($chkDrop_google=='A') echo "selected";?> >All</option><option value="S" <?php if($chkDrop_google=='S') echo "selected";?>>Selected</option><option value="D" <?php if($chkDrop_google=='D') echo "selected";?>>Deselected</option></select></td>
					<td align="right"><select name="drpgoogle-uk" onchange="filterRec(this.value,'<?php echo $_SERVER['PHP_SELF'];?>','google-uk')" ><option  value="A" <?php if($chkDrop_google_uk=='A') echo "selected";?> >All</option><option value="S" <?php if($chkDrop_google_uk=='S') echo "selected";?>>Selected</option><option value="D" <?php if($chkDrop_google_uk=='D') echo "selected";?>>Deselected</option></select></td>
				</tr>
