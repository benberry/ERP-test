<fieldset>
	...
	<p><label>Subject:</label><input type="text" name="name_1" value="<?=$row[name_1]; ?>"></p>
	
	<p><label>Content:</label><textarea name="content_1" class="richeditor" ><?=$row[content_1]; ?></textarea></p>
